...
events <- c(
  "1904-01-01", NA, "Protection of the Marikina Watershed\nReserve (MWR) (25,913.15 ha)",
  "1915-01-01", "1996-01-01", "Reduction of MWR: private entities, resettlements, waste disposal",
...
basemap <- get_stadiamap(
  c(left = extent_luzon[1], right = extent_luzon[2], 
